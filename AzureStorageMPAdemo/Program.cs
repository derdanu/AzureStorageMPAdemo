...
namespace AzureStorageMPAdemo
{
    internal class Program
    {
        ...
        private static readonly string storageAccountName = "dafalknempa";
        ...
        static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Generating Fake Data: 50 files, each file 250 persons");
                generateFakePersionsJSON(fakeDataDirectory, 50, 250);
                ...
                Console.WriteLine($"Uploading files using Azure Blob API and keeping folderstructure: Containername: {containerNameBlob}");
                ...
                Console.WriteLine($"Downloading files and creating folderstructure locally using Azure DFS API to: {fakeDataDirectoryDownload}");
